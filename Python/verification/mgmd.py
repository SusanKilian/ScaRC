...
def read_csv(path, chid, time, v1, v2, v3, v4, v5, v6, v7, v8, i):
...
def plot_csv(path, case, chid, time, quan, name, tstart, tend):
    ...
    ax.set_xlim(0.1,0.5)
    if name == 'pres': ax.set_ylim(-4.0, 3.5)
...
chid=[]
chid.append('mgm_mean_cg_1mesh')
chid.append('mgm_mean_luperm_1mesh')
chid.append('mgm_mean_pardiso_1mesh')
chid.append('mgm_mean_opt_1mesh')
chid.append('mgm_mean_cg_2mesh')
chid.append('mgm_mean_luperm_2mesh')
chid.append('mgm_mean_pardiso_2mesh')
chid.append('mgm_mean_opt_2mesh')
