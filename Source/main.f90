...
MAIN_LOOP: DO
...
#ifdef WITH_SCARC_DEBUG
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX, MY_RANK+1, 'FVX BEFORE PI_PREDICTOR 1')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX_B, MY_RANK+1, 'FVX_B BEFORE PI_PREDICTOR 1')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%H, MY_RANK+1, 'H BEFORE PI_PREDICTOR 1')
#endif
      CALL PRESSURE_ITERATION_SCHEME
      CALL EVAC_PRESSURE_ITERATION_SCHEME

#ifdef WITH_SCARC_DEBUG
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX, MY_RANK+1, 'FVX IN SUSI 2')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX_B, MY_RANK+1, 'FVX_B IN SUSI 2')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%H, MY_RANK+1, 'H AFTER PI_PREDICTOR 1')
#endif
   ...
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX, MY_RANK+1, 'FVX IN SUSI 3')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX_B, MY_RANK+1, 'FVX_B IN SUSI 3')
#endif
...
#ifdef WITH_SCARC_DEBUG2
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX, MY_RANK+1, 'FVX IN SUSI 4')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX_B, MY_RANK+1, 'FVX_B IN SUSI 4')
#endif
   DO NM=LOWER_MESH_INDEX,UPPER_MESH_INDEX
...
#ifdef WITH_SCARC_DEBUG2
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX, MY_RANK+1, 'FVX IN SUSI 5')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX_B, MY_RANK+1, 'FVX_B IN SUSI 5')
#endif
...
#ifdef WITH_SCARC_DEBUG2
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX, MY_RANK+1, 'FVX IN SUSI 6')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX_B, MY_RANK+1, 'FVX_B IN SUSI 6')
#endif
   IF (LEVEL_SET_MODE==2 .AND. CHECK_FREEZE_VELOCITY) CALL CHECK_FREEZE_VELOCITY_STATUS
...
#ifdef WITH_SCARC_DEBUG2
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX, MY_RANK+1, 'FVX IN SUSI 61')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX_B, MY_RANK+1, 'FVX_B IN SUSI 61')
#endif
...
#ifdef WITH_SCARC_DEBUG2
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX, MY_RANK+1, 'FVX IN SUSI 62')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX_B, MY_RANK+1, 'FVX_B IN SUSI 62')
#endif
         IF (.NOT.CYLINDRICAL) CALL VELOCITY_FLUX(T,DT,NM,APPLY_TO_ESTIMATED_VARIABLES=.TRUE.)
#ifdef WITH_SCARC_DEBUG2
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX, MY_RANK+1, 'FVX IN SUSI 63')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX_B, MY_RANK+1, 'FVX_B IN SUSI 63')
#endif
         IF (     CYLINDRICAL) CALL VELOCITY_FLUX_CYLINDRICAL(T,NM,APPLY_TO_ESTIMATED_VARIABLES=.TRUE.)
#ifdef WITH_SCARC_DEBUG2
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX, MY_RANK+1, 'FVX IN SUSI 64')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX_B, MY_RANK+1, 'FVX_B IN SUSI 64')
#endif
      ENDIF
...
#ifdef WITH_SCARC_DEBUG2
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX, MY_RANK+1, 'FVX IN SUSI 65')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX_B, MY_RANK+1, 'FVX_B IN SUSI 65')
#endif
      IF (ANY(SPECIES_MIXTURE%CONDENSATION_SMIX_INDEX>0)) CALL CONDENSATION_EVAPORATION(DT,NM)
#ifdef WITH_SCARC_DEBUG2
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX, MY_RANK+1, 'FVX IN SUSI 66')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX_B, MY_RANK+1, 'FVX_B IN SUSI 66')
#endif
   ENDDO COMPUTE_DIVERGENCE_2

#ifdef WITH_SCARC_DEBUG2
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX, MY_RANK+1, 'FVX IN SUSI 7')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX_B, MY_RANK+1, 'FVX_B IN SUSI 7')
#endif
...
#ifdef WITH_SCARC_DEBUG2
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX, MY_RANK+1, 'FVX IN SUSI 8')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX_B, MY_RANK+1, 'FVX_B IN SUSI 8')
#endif
...
#ifdef WITH_SCARC_DEBUG2
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX, MY_RANK+1, 'FVX IN SUSI 9')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX_B, MY_RANK+1, 'FVX_B IN SUSI 9')
#endif
...
#ifdef WITH_SCARC_DEBUG
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX, MY_RANK+1, 'FVX BEFORE PI_CORRECTOR 10')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX_B, MY_RANK+1, 'FVX_B BEFORE PI_CORRECTOR 10')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%HS, MY_RANK+1, 'HS BEFORE PI_CORRECTOR 10')
#endif
...
#ifdef WITH_SCARC_DEBUG
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX, MY_RANK+1, 'FVX AFTER PI_CORRECTOR 10')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX_B, MY_RANK+1, 'FVX_B AFTER PI_CORRECTOR 10')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%HS, MY_RANK+1, 'HS AFTER PI_CORRECTOR 10')
#endif
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) '?????????????????????????????????????????????????????????'
WRITE(MSG%LU_DEBUG,*) 'MAIN: PRESSURE_ITERATIONS = ', PRESSURE_ITERATIONS
WRITE(MSG%LU_DEBUG,*) 'MAIN: TOTAL_PRESSURE_ITERATIONS = ', TOTAL_PRESSURE_ITERATIONS
WRITE(MSG%LU_DEBUG,*) 'MAIN: ITERATE_BAROCLINIC_TERM =', ITERATE_BAROCLINIC_TERM
WRITE(MSG%LU_DEBUG,*) 'MAIN: PREDICTOR = ', PREDICTOR
WRITE(MSG%LU_DEBUG,*) 'MAIN: PRESSURE_TOLERANCE = ', PRESSURE_TOLERANCE
WRITE(MSG%LU_DEBUG,*) 'MAIN: VELOCITY_TOLERANCE = ', VELOCITY_TOLERANCE
WRITE(MSG%LU_DEBUG,*) '?????????????????????????????????????????????????????????'
#endif
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'PI: DOIT !!!'
#endif
      DO NM=LOWER_MESH_INDEX,UPPER_MESH_INDEX
         IF (EVACUATION) CYCLE

#ifdef WITH_SCARC_DEBUG
   WRITE(MSG%LU_DEBUG,*) 'BAROCLINIC = ', BAROCLINIC
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX, MY_RANK+1, 'FVX IN PI 1')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX_B, MY_RANK+1, 'FVX_B IN PI 1')
#endif
         !IF (BAROCLINIC.OR.IS_INSEPARABLE) CALL BAROCLINIC_CORRECTION(T,NM)
         IF (BAROCLINIC) CALL BAROCLINIC_CORRECTION(T,NM)

#ifdef WITH_SCARC_DEBUG
   WRITE(MSG%LU_DEBUG,*) 'BAROCLINIC = ', BAROCLINIC
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX, MY_RANK+1, 'FVX IN PI 2')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX_B, MY_RANK+1, 'FVX_B IN PI 2')
#endif
         IF (CC_IBM) THEN
   ...
   ENDIF
#ifdef WITH_SCARC_DEBUG
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX, MY_RANK+1, 'FVX IN PI 3')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX_B, MY_RANK+1, 'FVX_B IN PI 3')
#endif
...
#ifdef WITH_SCARC_DEBUG
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX, MY_RANK+1, 'FVX IN PI 4')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX_B, MY_RANK+1, 'FVX_B IN PI 4')
#endif
      CALL PRESSURE_SOLVER_COMPUTE_RHS(T,DT,NM)
   ENDDO
#ifdef WITH_SCARC_DEBUG
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX, MY_RANK+1, 'FVX IN PI 5')
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX_B, MY_RANK+1, 'FVX_B IN PI 5')
#endif
...
#ifdef WITH_SCARC_DEBUG
   CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(MY_RANK+1)%FVX_B, MY_RANK+1, 'FVX_B IN PI 6')
#endif
...
#ifdef WITH_SCARC_DEBUG
   WRITE(MSG%LU_DEBUG,'(a,i6,a,i6,a,2e14.6,a,2e14.6)') 'PI=', PRESSURE_ITERATIONS, ': TPI=',TOTAL_PRESSURE_ITERATIONS,&
                         ': VEL_ERR=', MAXVAL(VELOCITY_ERROR_MAX),VELOCITY_TOLERANCE,&
                         ': PRES_ERR=',MAXVAL(PRESSURE_ERROR_MAX), PRESSURE_TOLERANCE
#endif
   ! If the VELOCITY_TOLERANCE is satisfied or max/min iterations are hit, exit the loop.

   IF (MAXVAL(PRESSURE_ERROR_MAX)<PRESSURE_TOLERANCE) THEN
      ITERATE_BAROCLINIC_TERM = .FALSE.
#ifdef WITH_SCARC_DEBUG
   WRITE(MSG%LU_DEBUG,*) 'CHECKING ITERATE_BAROCLINIC_TERM:', ITERATE_BAROCLINIC_TERM
#endif
   ENDIF
...
#ifdef WITH_SCARC_DEBUG
   WRITE(MSG%LU_DEBUG,*) 'CHECKING LEAVING OF PI'
#endif
      EXIT PRESSURE_ITERATION_LOOP
#ifdef WITH_SCARC_DEBUG
   WRITE(MSG%LU_DEBUG,*) 'CHECKING LEAVING OF PI : NOT DONE'
#endif
   ENDIF
