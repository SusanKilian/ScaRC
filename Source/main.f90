...
WRITE(MSG%LU_DEBUG,*) '============================================LOOPING TIME STEP'
      ...
      COMPUTE_DENSITY_LOOP: DO NM=LOWER_MESH_INDEX,UPPER_MESH_INDEX
         ...
         !MESHES(1)%RHO = 0.1195253017817356E+01
         !MESHES(1)%RHOS = 0.1195253017817356E+01
      ENDDO COMPUTE_DENSITY_LOOP

#ifdef WITH_SCARC_DEBUG
IF (MY_RANK == 0) THEN
CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(1)%RHO, 1, 'MAIN: RHO 0')
CALL SCARC_DEBUG_VECTOR3_BIG (MESHES(1)%RHOS, 1, 'MAIN: RHOS 0')
ENDIF
#endif
...
#ifdef WITH_SCARC_DEBUG22
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%DDDT, 1, 'MAIN: DDDT A')
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%RHO, 1, 'MAIN: RHO A')
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%RHOS, 1, 'MAIN: RHOS A')
#endif
...
#ifdef WITH_SCARC_DEBUG22
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%RHOS, 1, 'MAIN: RHOS A1')
#endif
         CALL WALL_BC(T,DT,NM)
#ifdef WITH_SCARC_DEBUG22
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%RHOS, 1, 'MAIN: RHOS A2')
#endif
         CALL PARTICLE_MOMENTUM_TRANSFER(NM)
#ifdef WITH_SCARC_DEBUG22
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%RHOS, 1, 'MAIN: RHOS A3')
#endif
         CALL DIVERGENCE_PART_1(T,DT,NM)
      ENDDO COMPUTE_WALL_BC_LOOP_A

#ifdef WITH_SCARC_DEBUG22
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%DDDT, 1, 'MAIN: DDDT B')
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%RHO, 1, 'MAIN: RHO B')
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%RHOS, 1, 'MAIN: RHOS B')
#endif
...
#ifdef WITH_SCARC_DEBUG22
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%DDDT, 1, 'MAIN: DDDT B2')
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%RHO, 1, 'MAIN: RHO B2')
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%RHOS, 1, 'MAIN: RHOS B2')
#endif
...
#endif
#ifdef WITH_SCARC_DEBUG22
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%DDDT, 1, 'MAIN: DDDT C')
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%RHO, 1, 'MAIN: RHO C')
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%RHOS, 1, 'MAIN: RHOS C')
#endif
...
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%DDDT, 1, 'MAIN: DDDT D')
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%RHO, 1, 'MAIN: RHO D')
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%RHOS, 1, 'MAIN: RHOS D')
#endif
...
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%DDDT, 1, 'MAIN: DDDT E')
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%RHO, 1, 'MAIN: RHO E')
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%RHOS, 1, 'MAIN: RHOS E')
#endif
         EXIT CHANGE_TIME_STEP_LOOP
      ENDIF
...
#ifdef WITH_SCARC_DEBUG22
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%DDDT, 1, 'MAIN: DDDT F')
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%RHO, 1, 'MAIN: RHO F')
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%RHOS, 1, 'MAIN: RHOS F')
#endif
...
#ifdef WITH_SCARC_DEBUG22
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%DDDT, 1, 'MAIN: DDDT G')
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%RHO, 1, 'MAIN: RHO G')
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%RHOS, 1, 'MAIN: RHOS G')
#endif
...
#ifdef WITH_SCARC_DEBUG22
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%DDDT, 1, 'MAIN: DDDT H')
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%RHO, 1, 'MAIN: RHO H')
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%RHOS, 1, 'MAIN: RHOS H')
#endif
...
#ifdef WITH_SCARC_DEBUG22
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%DDDT, 1, 'MAIN: DDDT I')
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%RHO, 1, 'MAIN: RHO I')
CALL SCARC_DEBUG2_VECTOR3_BIG (MESHES(1)%RHOS, 1, 'MAIN: RHOS I')
#endif
