...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A, 4I4, 2E14.6)') 'UNPACK_MGM_TRUE: NM, NOM, ICG, IWG, OUHL, OUHL_PREV:', &
                                                         NM, NOM, ICG, IWG, OUHL(IWG), OUHL_PREV(IWG)
#endif
      LL = LL + 2
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A, 4I4, 1E14.6)') 'UNPACK_MGM_VELO: NM, NOM, ICG, IWG, OVEL:', NM, NOM, ICG, IWG, OVEL(IWG)
#endif
      LL = LL + 1
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A, 4I4, 2E14.6)') 'UNPACK_MGM_VELO: NM, NOM, ICG, IWG, OUIP:', NM, NOM, ICG, IWG, OUIP(IWG), OVEL(IWG)
#endif
      LL = LL + 2
   ENDDO UNPACK_MGM_VELO
ENDDO
