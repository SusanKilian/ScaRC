...
IF (ABS(DIFF1) > TWO_EPSILON_EB) WRITE(MSG%LU_DEBUG, *) 'A: DIFF1 = ', DIFF1, 'VAL, VAL2:', VAL, VAL2
...
IF (ABS(DIFF2) > TWO_EPSILON_EB) WRITE(MSG%LU_DEBUG, *) 'A: DIFF2 = ', DIFF2, 'VAL, VAL2:', VAL, VAL2
   ENDDO COL_LOOP
   !LM%ROW(IC+1) = IL
   !UM%ROW(IC+1) = IL
