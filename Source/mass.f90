...
USE GLOBAL_CONSTANTS, ONLY: N_TOTAL_SCALARS,PREDICTOR,DO_EVACUATION,SOLID_PHASE_ONLY,T_USED
...
USE GLOBAL_CONSTANTS, ONLY: N_TRACKED_SPECIES,DO_EVACUATION,PREDICTOR,N_ZONE,SOLID_PHASE_ONLY,T_USED,CC_IBM
...
USE CC_SCALARS_IBM, ONLY : SET_EXIMADVFLX_3D,SET_DOMAINADVFLX_3D,ROTATED_CUBE_RHS_ZZ
