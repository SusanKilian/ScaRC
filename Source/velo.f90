...
USE SCARC_MESSAGES, ONLY : SCARC_DEBUG_VECTOR3_BIG
#endif
USE MATH_FUNCTIONS, ONLY: EVALUATE_RAMP
...
#ifdef WITH_SCARC_DEBUG
   CALL SCARC_DEBUG_VECTOR3_BIG (UU, NM, 'UU IN VELOCITY_FLUX 1')
   CALL SCARC_DEBUG_VECTOR3_BIG (WW, NM, 'WW IN VELOCITY_FLUX 1')
   CALL SCARC_DEBUG_VECTOR3_BIG (DP, NM, 'DP IN VELOCITY_FLUX 1')
   CALL SCARC_DEBUG_VECTOR3_BIG (RHOP, NM, 'RHOP IN VELOCITY_FLUX 1')
#endif
...
#ifdef WITH_SCARC_DEBUG
   CALL SCARC_DEBUG_VECTOR3_BIG (OMX, NM, 'OMX IN VELOCITY_FLUX 1')
   CALL SCARC_DEBUG_VECTOR3_BIG (OMY, NM, 'OMY IN VELOCITY_FLUX 1')
   CALL SCARC_DEBUG_VECTOR3_BIG (OMZ, NM, 'OMZ IN VELOCITY_FLUX 1')
   CALL SCARC_DEBUG_VECTOR3_BIG (TXY, NM, 'TXY IN VELOCITY_FLUX 1')
   CALL SCARC_DEBUG_VECTOR3_BIG (TXZ, NM, 'TXZ IN VELOCITY_FLUX 1')
   CALL SCARC_DEBUG_VECTOR3_BIG (TYZ, NM, 'TYZ IN VELOCITY_FLUX 1')
#endif
...
#ifdef WITH_SCARC_DEBUG
   CALL SCARC_DEBUG_VECTOR3_BIG (FVX, NM, 'FVX IN VELOCITY_FLUX 1')
#endif
...
REAL(EB) :: MUY,UP,UM,WP,WM,VTRM,DTXZDZ,DTXZDX,DUDX,DWDZ,DUDZ,DWDX,WOMY,UOMY,OMYP,OMYM,TXZP,TXZM, &
            AH,RRHO,GX,GZ,TXXP,TXXM,TZZP,TZZM,DTXXDX,DTZZDZ,DUMMY=0._EB,T_NOW
...
#ifdef WITH_SCARC_DEBUG
    CALL SCARC_DEBUG_VECTOR3_BIG (FVX, NM, 'FVX: NO_FLUX 1')
#endif
...
#ifdef WITH_SCARC_DEBUG
    CALL SCARC_DEBUG_VECTOR3_BIG (FVX, NM, 'FVX: NO_FLUX 2')
#endif
T_USED(4)=T_USED(4)+CURRENT_TIME()-T_NOW
...
#ifdef WITH_SCARC_DEBUG
    CALL SCARC_DEBUG_VECTOR3_BIG (U, NM, 'BEFORE VELOCITY_PREDICTOR: U')
    CALL SCARC_DEBUG_VECTOR3_BIG (W, NM, 'BEFORE VELOCITY_PREDICTOR: W')
    CALL SCARC_DEBUG_VECTOR3_BIG (US, NM, 'BEFORE VELOCITY_PREDICTOR: US')
    CALL SCARC_DEBUG_VECTOR3_BIG (WS, NM, 'BEFORE VELOCITY_PREDICTOR: WS')
    CALL SCARC_DEBUG_VECTOR3_BIG (FVX, NM, 'BEFORE VELOCITY_PREDICTOR: FVX')
    CALL SCARC_DEBUG_VECTOR3_BIG (FVZ, NM, 'BEFORE VELOCITY_PREDICTOR: FVZ')
    CALL SCARC_DEBUG_VECTOR3_BIG (FVX_B, NM, 'BEFORE VELOCITY_PREDICTOR: FVX_B')
    CALL SCARC_DEBUG_VECTOR3_BIG (FVZ_B, NM, 'BEFORE VELOCITY_PREDICTOR: FVZ_B')
    CALL SCARC_DEBUG_VECTOR3_BIG (H, NM, 'BEFORE VELOCITY_PREDICTOR: H')
#endif
   DO K=1,KBAR
      DO J=1,JBAR
         DO I=0,IBAR
...
#ifdef WITH_SCARC_DEBUG
    CALL SCARC_DEBUG_VECTOR3_BIG (US, NM, 'AFTER VELOCITY_PREDICTOR: US')
    CALL SCARC_DEBUG_VECTOR3_BIG (WS, NM, 'AFTER VELOCITY_PREDICTOR: WS')
#endif
...
#ifdef WITH_SCARC_DEBUG
    CALL SCARC_DEBUG_VECTOR3_BIG (U, NM, 'BEFORE VELOCITY_CORRECTOR: U')
    CALL SCARC_DEBUG_VECTOR3_BIG (W, NM, 'BEFORE VELOCITY_CORRECTOR: W')
    CALL SCARC_DEBUG_VECTOR3_BIG (US, NM, 'BEFORE VELOCITY_CORRECTOR: US')
    CALL SCARC_DEBUG_VECTOR3_BIG (WS, NM, 'BEFORE VELOCITY_CORRECTOR: WS')
    CALL SCARC_DEBUG_VECTOR3_BIG (FVX, NM, 'BEFORE VELOCITY_CORRECTOR: FVX')
    CALL SCARC_DEBUG_VECTOR3_BIG (FVZ, NM, 'BEFORE VELOCITY_CORRECTOR: FVZ')
    CALL SCARC_DEBUG_VECTOR3_BIG (FVX_B, NM, 'BEFORE VELOCITY_CORRECTOR: FVX_B')
    CALL SCARC_DEBUG_VECTOR3_BIG (FVZ_B, NM, 'BEFORE VELOCITY_CORRECTOR: FVZ_B')
    CALL SCARC_DEBUG_VECTOR3_BIG (H, NM, 'BEFORE VELOCITY_CORRECTOR: H')
#endif
...
#ifdef WITH_SCARC_DEBUG
    CALL SCARC_DEBUG_VECTOR3_BIG (U, NM, 'AFTER VELOCITY_CORRECTOR: U')
    CALL SCARC_DEBUG_VECTOR3_BIG (W, NM, 'AFTER VELOCITY_CORRECTOR: W')
#endif
...
USE SCARC_VARIABLES, ONLY: IS_INSEPARABLE
#ifdef WITH_SCARC_DEBUG
USE SCARC_MESSAGES, ONLY: SCARC_DEBUG_VECTOR3_BIG, MSG
#endif
USE MATH_FUNCTIONS, ONLY: EVALUATE_RAMP
REAL(EB), INTENT(IN) :: T
INTEGER, INTENT(IN) :: NM
...
REAL(EB) :: P_EXTERNAL,TSI,TIME_RAMP_FACTOR,DUMMY=0._EB,UN,T_NOW, F_OLD
LOGICAL  :: INFLOW
...
IF (IS_INSEPARABLE) BAROCLINIC_TERMS_ATTACHED = .FALSE.
...
#ifdef WITH_SCARC_DEBUG
   IF (PREDICTOR) THEN
      WRITE(MSG%LU_DEBUG,*) 'BAROCLINIC_CORRECTION: PREDICTOR'
   ELSE
      WRITE(MSG%LU_DEBUG,*) 'BAROCLINIC_CORRECTION: CORRECTOR'
   ENDIF
   CALL SCARC_DEBUG_VECTOR3_BIG (RHMK, NM, 'RHMK BEFORE BAROCLINIC_CORRECTION 1')
   CALL SCARC_DEBUG_VECTOR3_BIG (RHOP, NM, 'RHOP BEFORE BAROCLINIC_CORRECTION 1')
   CALL SCARC_DEBUG_VECTOR3_BIG (FVX, NM, 'FVX BEFORE BAROCLINIC_CORRECTION 1')
   CALL SCARC_DEBUG_VECTOR3_BIG (FVX_B, NM, 'FVX_B BEFORE BAROCLINIC_CORRECTION 1')
#endif
...
DO K=1,KBAR
   DO J=1,JBAR
      DO I=0,IBAR
         ...
         IF (.NOT.IS_INSEPARABLE) THEN
            F_OLD = FVX(I,J,K)
            FVX(I,J,K) = FVX(I,J,K) + FVX_B(I,J,K)
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'BAROCLINIC_CORRECTION: I,J,K, F_OLD, FVX_B, FVX:', I,J,K,F_OLD, FVX_B(I,J,K), FVX(I,J,K)
#endif
         ENDIF
      ENDDO
   ENDDO
   ...
   DO K=1,KBAR
      DO J=0,JBAR
         DO I=1,IBAR
            ...
            IF (.NOT.IS_INSEPARABLE) FVY(I,J,K) = FVY(I,J,K) + FVY_B(I,J,K)
         ENDDO
      ENDDO
   ENDDO
!$OMP END DO nowait
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'BAROCLINIC_CORRECTION: I,J,K, F_OLD, FVZ_B, FVZ:', I,J,K,F_OLD, FVZ_B(I,J,K), FVZ(I,J,K)
#endif
         ENDIF
      ENDDO
   ENDDO
...
#ifdef WITH_SCARC_DEBUG
   CALL SCARC_DEBUG_VECTOR3_BIG (FVX, NM, 'FVX AFTER BAROCLINIC_CORRECTION 2')
   CALL SCARC_DEBUG_VECTOR3_BIG (FVX_B, NM, 'FVX_B AFTER BAROCLINIC_CORRECTION 2')
#endif
T_USED(4) = T_USED(4) + CURRENT_TIME() - T_NOW
