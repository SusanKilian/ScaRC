...
CALL POINT_TO_MESH(NM)
   ...
   CALL SCARC_DEBUG_VECTOR3_BIG (V, NM, 'BEFORE VELOCITY_CORRECTOR: V')
   ...
   CALL SCARC_DEBUG_VECTOR3_BIG (VS, NM, 'BEFORE VELOCITY_CORRECTOR: VS')
   ...
   CALL SCARC_DEBUG_VECTOR3_BIG (FVY, NM, 'BEFORE VELOCITY_CORRECTOR: FVY')
   ...
   CALL SCARC_DEBUG_VECTOR3_BIG (FVY_B, NM, 'BEFORE VELOCITY_CORRECTOR: FVY_B')
...
ENDIF FREEZE_VELOCITY_IF
   ...
   CALL SCARC_DEBUG_VECTOR3_BIG (V, NM, 'AFTER VELOCITY_CORRECTOR: V')
...
#ifdef WITH_SCARC_DEBUG
   CALL SCARC_DEBUG_VECTOR3_BIG (UU, NM, 'BAROCLINIC_CORRECTION:B: UU')
   CALL SCARC_DEBUG_VECTOR3_BIG (VV, NM, 'BAROCLINIC_CORRECTION:B: VV')
   CALL SCARC_DEBUG_VECTOR3_BIG (WW, NM, 'BAROCLINIC_CORRECTION:B: WW')
   CALL SCARC_DEBUG_VECTOR3_BIG (RHOP, NM, 'BAROCLINIC_CORRECTION:B: RHOP')
   CALL SCARC_DEBUG_VECTOR3_BIG (HP, NM, 'BAROCLINIC_CORRECTION:B: HP')
#endif
...
!$OMP END DO
   ...
   CALL SCARC_DEBUG_VECTOR3_BIG (FVX, NM, 'BAROCLINIC_CORRECTION:B: FVX')
   CALL SCARC_DEBUG_VECTOR3_BIG (FVZ, NM, 'BAROCLINIC_CORRECTION:B: FVZ')
   CALL SCARC_DEBUG_VECTOR3_BIG (FVX_B, NM, 'BAROCLINIC_CORRECTION:B: FVX_B')
   CALL SCARC_DEBUG_VECTOR3_BIG (FVZ_B, NM, 'BAROCLINIC_CORRECTION:B: FVZ_B')
#endif
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A, 3I4,4E14.6)') 'BAROCLINIC_CORRECTION: I,J,K, RRHO+, RRHO, FVX_B, FVX:', &
                                       I,J,K, RRHO(I+1,J,K), RRHO(I,J,K), FVX_B(I,J,K), FVX(I,J,K)
#endif
      ENDDO
   ENDDO
ENDDO
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A, 3I4,4E14.6)') 'BAROCLINIC_CORRECTION: I,J,K, RRHO+, RRHO, FVZ_B, FVZ:', &
                                       I,J,K, RRHO(I,J,K+1), RRHO(I,J,K), FVZ_B(I,J,K), FVZ(I,J,K)
#endif
      ENDDO
   ENDDO
ENDDO
...
!$OMP END PARALLEL
   ...
   CALL SCARC_DEBUG_VECTOR3_BIG (FVX_B, NM, 'BAROCLINIC_CORRECTION:C: FVX_B')
   CALL SCARC_DEBUG_VECTOR3_BIG (FVZ_B, NM, 'BAROCLINIC_CORRECTION:C: FVZ_B')
#endif
