...
USE SCRC, ONLY: SCARC_METHOD, SCARC_GRID, SCARC_MATRIX, SCARC_SMOOTH, SCARC_PRECON, SCARC_COARSE, SCARC_COARSENING, &
                ...
                SCARC_MGM_BC, SCARC_MGM_LAPLACE_SOLVER, SCARC_POISSON
...
WRITE_SCARC: IF (TRIM(PRES_METHOD) == 'SCARC' .OR. TRIM(PRES_METHOD) == 'USCARC') THEN
   ...
   WRITE(LU_OUTPUT,'(3X,A25,A12)') 'Poisson type             ', TRIM(SCARC_POISSON)
