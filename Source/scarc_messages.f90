...
IF (NLEN < 10) THEN
   MSG%CFORM1 = "( E14.6)"  ; WRITE(MSG%CFORM1(2:2),'(I1.1)') NLEN
   MSG%CFORM4 = "( I5)"  ; WRITE(MSG%CFORM4(2:2),'(I1.1)') NLEN
ELSE
   MSG%CFORM1 = "(  E14.6)" ; WRITE(MSG%CFORM1(2:3),'(I2.2)') NLEN
   MSG%CFORM4 = "(  I5)" ; WRITE(MSG%CFORM4(2:3),'(I2.2)') NLEN
ENDIF
IF (NLEN+1 < 10) THEN
   MSG%CFORM2 = "( E14.6)"  ; WRITE(MSG%CFORM2(2:2),'(I1.1)') NLEN+1
ELSE
   MSG%CFORM2 = "(  E14.6)" ; WRITE(MSG%CFORM2(2:3),'(I2.2)') NLEN+1
ENDIF
IF (NLEN+2 < 10) THEN
   MSG%CFORM3 = "( E14.6)"  ; WRITE(MSG%CFORM3(2:2),'(I1.1)') NLEN+2
ELSE
   MSG%CFORM3 = "(  E14.6)" ; WRITE(MSG%CFORM3(2:3),'(I2.2)') NLEN+2
ENDIF
...
DO NM = LOWER_MESH_INDEX, UPPER_MESH_INDEX
   ...
   WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MESHES(MY_RANK+1)%FVX(I,1,K), I=0, M%IBAR), K=M%KBAR,0,-1)
   !WRITE(MSG%LU_DEBUG,*) 'FVZ'
   !WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MESHES(MY_RANK+1)%FVZ(I,1,K), I=0, M%IBAR), K=M%KBAR,0,-1)
   IF (IS_MGM) THEN
      ...
      IF (NTYPE >= 1) THEN
         WRITE(MSG%LU_DEBUG,*) 'H'
         WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MESHES(MY_RANK+1)%H(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,0,-1)
         WRITE(MSG%LU_DEBUG,*) 'HS'
         WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MESHES(MY_RANK+1)%HS(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,0,-1)
      ENDIF
   ENDIF
   ...
   !ELSE
      IF (IS_MGM) THEN
         ...
         WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MGM%UVEL(I,1,K), I=0, M%IBAR), K=M%KBAR,0,-1)
      ENDIF
      WRITE(MSG%LU_DEBUG,*) 'MESHES(MY_RANK+1)%U'
      WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MESHES(MY_RANK+1)%U(I,1,K), I=0, M%IBAR), K=M%KBAR,0,-1)
      WRITE(MSG%LU_DEBUG,*) 'MESHES(MY_RANK+1)%US'
      WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MESHES(MY_RANK+1)%US(I,1,K), I=0, M%IBAR), K=M%KBAR,0,-1)
      !WRITE(MSG%LU_DEBUG,*) 'MESHES(MY_RANK+1)%W'
      !WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MESHES(MY_RANK+1)%W(I,1,K), I=0, M%IBAR), K=M%KBAR,0,-1)
      !WRITE(MSG%LU_DEBUG,*) 'MESHES(MY_RANK+1)%WS'
      !WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MESHES(MY_RANK+1)%WS(I,1,K), I=0, M%IBAR), K=M%KBAR,0,-1)
