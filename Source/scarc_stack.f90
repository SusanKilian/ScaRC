...
SV%TYPE_MGM_BC        = TYPE_MGM_BC
SV%TYPE_MGM_INTERPOL  = TYPE_MGM_INTERPOL
SV%TYPE_MGM_LAPLACE   = TYPE_MGM_LAPLACE
...
TYPE_MGM_BC        = SV%TYPE_MGM_BC
TYPE_MGM_INTERPOL  = SV%TYPE_MGM_INTERPOL
TYPE_MGM_LAPLACE   = SV%TYPE_MGM_LAPLACE
...
IF (NP > 0) THEN
   ...
   TYPE_MGM_BC         = SVP%TYPE_MGM_BC
   TYPE_MGM_INTERPOL   = SVP%TYPE_MGM_INTERPOL
   TYPE_MGM_LAPLACE    = SVP%TYPE_MGM_LAPLACE
...
SV%TYPE_LEVEL(0:2)    = SVP%TYPE_LEVEL(0:2)
SV%TYPE_MATRIX        = SVP%TYPE_MATRIX
SV%TYPE_MGM_BC        = SVP%TYPE_MGM_BC
SV%TYPE_MGM_INTERPOL  = SVP%TYPE_MGM_INTERPOL
SV%TYPE_MGM_LAPLACE   = SVP%TYPE_MGM_LAPLACE
SV%TYPE_MKL_PRECISION = SVP%TYPE_MKL_PRECISION
SV%TYPE_STAGE         = SVP%TYPE_STAGE
