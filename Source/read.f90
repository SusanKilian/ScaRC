...
NAMELIST /MISC/ AEROSOL_AL2O3,AEROSOL_SCRUBBING,AGGLOMERATION,ALIGNMENT_TOLERANCE,ALLOW_SURFACE_PARTICLES, &
                ...
                STORE_DIVERGENCE_CORRECTION,TAU_DEFAULT,TENSOR_DIFFUSIVITY,TERRAIN_CASE,TERRAIN_IMAGE,&
                TEST_NEW_OPEN,TEXTURE_ORIGIN,&
...
REAL(EB) :: TAU_Q,TAU_V,TAU_T,TAU_MF(MAX_SPECIES),HRRPUA,MLRPUA,TEXTURE_WIDTH,TEXTURE_HEIGHT,VEL_T(2),&
            ...
            Z_0,AERODYNAMIC_ROUGHNESS,PARTICLE_EXTRACTION_VELOCITY
...
USE SCRC, ONLY: SCARC_METHOD, SCARC_GRID, SCARC_MATRIX, SCARC_ERROR_FILE, SCARC_ACCURACY, SCARC_COARSENING, &
                SCARC_KRYLOV_ITERATIONS, SCARC_KRYLOV_ACCURACY, SCARC_KRYLOV_INTERPOL, SCARC_MGM_BC, SCARC_MGM_INTERPOL, &
                SCARC_MGM_ITERATIONS, SCARC_MGM_ACCURACY, SCARC_MGM_USE_EXACT_INITIAL, SCARC_MGM_USE_LU, SCARC_MGM_USE_PERMUTATION, &
