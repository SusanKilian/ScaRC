...
USE MATH_FUNCTIONS, ONLY: EVALUATE_RAMP,INTERPOLATE1D_UNIFORM,SCALAR_FACE_VALUE
      ...
      OFF_WALL_SELECT_1: SELECT CASE(IOR)
         CASE( 1) OFF_WALL_SELECT_1
            ...
            IF ((UU(II+1,JJ,KK)>0._EB) .AND. .NOT.(WALL_INDEX(CELL_INDEX(II+1,JJ,KK),+1)>0)) THEN
               ...
               ELSE
                  ZZZ(1:3) = (/RHO_H_S_P(II+1,JJ,KK),RHO_H_S_P(II+1:II+2,JJ,KK)/)
               ENDIF
         ...
         CASE(-1) OFF_WALL_SELECT_1
            ...
            IF ((UU(II-2,JJ,KK)<0._EB) .AND. .NOT.(WALL_INDEX(CELL_INDEX(II-1,JJ,KK),-1)>0)) THEN
               ...
               ELSE
                  ZZZ(2:4) = (/RHO_H_S_P(II-2:II-1,JJ,KK),RHO_H_S_P(II-1,JJ,KK)/)
               ENDIF
         ...
         CASE( 2) OFF_WALL_SELECT_1
            IF ((VV(II,JJ+1,KK)>0._EB) .AND. .NOT.(WALL_INDEX(CELL_INDEX(II,JJ+1,KK),+2)>0)) THEN
               ...
               ELSE
                  ZZZ(1:3) = (/RHO_H_S_P(II,JJ+1,KK),RHO_H_S_P(II,JJ+1:JJ+2,KK)/)
               ENDIF
         ...
         CASE(-2) OFF_WALL_SELECT_1
            IF ((VV(II,JJ-2,KK)<0._EB) .AND. .NOT.(WALL_INDEX(CELL_INDEX(II,JJ-1,KK),-2)>0)) THEN
               ...
               ELSE
                  ZZZ(2:4) = (/RHO_H_S_P(II,JJ-2:JJ-1,KK),RHO_H_S_P(II,JJ-1,KK)/)
               ENDIF
         ...
         CASE( 3) OFF_WALL_SELECT_1
            IF ((WW(II,JJ,KK+1)>0._EB) .AND. .NOT.(WALL_INDEX(CELL_INDEX(II,JJ,KK+1),+3)>0)) THEN
               ...
               ELSE
                  ZZZ(1:3) = (/RHO_H_S_P(II,JJ,KK+1),RHO_H_S_P(II,JJ,KK+1:KK+2)/)
               ENDIF
         ...
         CASE(-3) OFF_WALL_SELECT_1
            IF ((WW(II,JJ,KK-2)<0._EB) .AND. .NOT.(WALL_INDEX(CELL_INDEX(II,JJ,KK-1),-3)>0)) THEN
               ...
               ELSE
                  ZZZ(2:4) = (/RHO_H_S_P(II,JJ,KK-2:KK-1),RHO_H_S_P(II,JJ,KK-1)/)
               ENDIF
      ...
      OFF_WALL_SELECT_2: SELECT CASE(IOR)
         CASE( 1) OFF_WALL_SELECT_2
            ...
            IF ((UU(II+1,JJ,KK)>0._EB) .AND. .NOT.(WALL_INDEX(CELL_INDEX(II+1,JJ,KK),+1)>0)) THEN
               ...
               ELSE
                  ZZZ(1:3) = (/RHO_Z_P(II+1,JJ,KK),RHO_Z_P(II+1:II+2,JJ,KK)/)
               ENDIF
         ...
         CASE(-1) OFF_WALL_SELECT_2
            ...
            IF ((UU(II-2,JJ,KK)<0._EB) .AND. .NOT.(WALL_INDEX(CELL_INDEX(II-1,JJ,KK),-1)>0)) THEN
               ...
               ELSE
                  ZZZ(2:4) = (/RHO_Z_P(II-2:II-1,JJ,KK),RHO_Z_P(II-1,JJ,KK)/)
               ENDIF
         ...
         CASE( 2) OFF_WALL_SELECT_2
            IF ((VV(II,JJ+1,KK)>0._EB) .AND. .NOT.(WALL_INDEX(CELL_INDEX(II,JJ+1,KK),+2)>0)) THEN
               ...
               ELSE
                  ZZZ(1:3) = (/RHO_Z_P(II,JJ+1,KK),RHO_Z_P(II,JJ+1:JJ+2,KK)/)
               ENDIF
         ...
         CASE(-2) OFF_WALL_SELECT_2
            IF ((VV(II,JJ-2,KK)<0._EB) .AND. .NOT.(WALL_INDEX(CELL_INDEX(II,JJ-1,KK),-2)>0)) THEN
               ...
               ELSE
                  ZZZ(2:4) = (/RHO_Z_P(II,JJ-2:JJ-1,KK),RHO_Z_P(II,JJ-1,KK)/)
               ENDIF
         ...
         CASE( 3) OFF_WALL_SELECT_2
            IF ((WW(II,JJ,KK+1)>0._EB) .AND. .NOT.(WALL_INDEX(CELL_INDEX(II,JJ,KK+1),+3)>0)) THEN
               ...
               ELSE
                  ZZZ(1:3) = (/RHO_Z_P(II,JJ,KK+1),RHO_Z_P(II,JJ,KK+1:KK+2)/)
               ENDIF
         ...
         CASE(-3) OFF_WALL_SELECT_2
            IF ((WW(II,JJ,KK-2)<0._EB) .AND. .NOT.(WALL_INDEX(CELL_INDEX(II,JJ,KK-1),-3)>0)) THEN
               ...
               ELSE
                  ZZZ(2:4) = (/RHO_Z_P(II,JJ,KK-2:KK-1),RHO_Z_P(II,JJ,KK-1)/)
               ENDIF
...
WRITE(MSG%LU_DEBUG,*) 'PREDICT_NORMALS: SOLID_BOUNDARY: IW, IOR, TRF, U_NORMAL_S, U_NORMAL_0:', &
                                        IW, IOR,TIME_RAMP_FACTOR, WC%ONE_D%U_NORMAL_S, WC%ONE_D%U_NORMAL_0
#endif
            ! Special Cases
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'PREDICT_NORMALS: SOLID_BOUNDARY: NEUMANN: IW, IOR, IIG, JJG, KKG, U_NORMAL_S:', &
                       IW, IOR, IIG, JJG, KKG, WC%ONE_D%U_NORMAL_S
#endif
                  CASE(-1)
                     WC%ONE_D%U_NORMAL_S = (U(IIG-1,JJG,KKG) + SF%VEL_GRAD*WC%ONE_D%RDN)
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'PREDICT_NORMALS: SOLID_BOUNDARY: NEUMANN: IW, IOR, IIG-1, JJG, KKG, U_NORMAL_S:', &
                       IW, IOR, IIG-1, JJG, KKG, WC%ONE_D%U_NORMAL_S
#endif
                  CASE( 2)
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'PREDICT_NORMALS: SOLID_BOUNDARY: NEUMANN: IW, IOR, IIG, JJG-1, KKG, U_NORMAL_S:', &
                       IW, IOR, IIG, JJG-1, KKG, WC%ONE_D%U_NORMAL_S
#endif
                  CASE( 3)
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'PREDICT_NORMALS: SOLID_BOUNDARY: NEUMANN: IW, IOR, IIG, JJG, KKG-1, U_NORMAL_S:', &
                       IW, IOR, IIG, JJG, KKG-1, WC%ONE_D%U_NORMAL_S
#endif
               END SELECT
            ENDIF NEUMANN_IF
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'PREDICT_NORMALS: SOLID_BOUNDARY: VENT: IW, IOR, JJ,KK, U_NORMAL_S:', IW, IOR, JJ,KK, WC%ONE_D%U_NORMAL_S
#endif
                     CASE(-1)
                        WC%ONE_D%U_NORMAL_S = WC%ONE_D%U_NORMAL_S + TIME_RAMP_FACTOR*VT%U_EDDY(JJ,KK)*PROFILE_FACTOR
#ifdef WITH_SCARC_DEBUG
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'PREDICT_NORMALS: SOLID_BOUNDARY: VENT: IW, IOR, II,KK, U_NORMAL_S:', IW, IOR, II,KK, WC%ONE_D%U_NORMAL_S
#endif
                     CASE(-2)
                        WC%ONE_D%U_NORMAL_S = WC%ONE_D%U_NORMAL_S + TIME_RAMP_FACTOR*VT%V_EDDY(II,KK)*PROFILE_FACTOR
#ifdef WITH_SCARC_DEBUG
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'PREDICT_NORMALS: SOLID_BOUNDARY: VENT: IW, IOR, II,JJ, U_NORMAL_S:', IW, IOR, II,JJ, WC%ONE_D%U_NORMAL_S
#endif
                     CASE(-3)
                        WC%ONE_D%U_NORMAL_S = WC%ONE_D%U_NORMAL_S + TIME_RAMP_FACTOR*VT%W_EDDY(II,JJ)*PROFILE_FACTOR
#ifdef WITH_SCARC_DEBUG
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'PREDICT_NORMALS: OPEN_BOUNDARY: IW, IOR, II,JJ, KK, U_NORMAL_S:', IW, IOR, II,JJ, KK, WC%ONE_D%U_NORMAL_S
#endif
               CASE(-1)
                  WC%ONE_D%U_NORMAL_S =  U(II-1,JJ,KK)
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'PREDICT_NORMALS: OPEN_BOUNDARY: IW, IOR, II-1,JJ, KK, U_NORMAL_S:', IW, IOR, II-1,JJ, KK, WC%ONE_D%U_NORMAL_S
#endif
               CASE( 2)
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'PREDICT_NORMALS: OPEN_BOUNDARY: IW, IOR, II,JJ-1, KK, U_NORMAL_S:', IW, IOR, II,JJ-1, KK, WC%ONE_D%U_NORMAL_S
#endif
               CASE( 3)
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'PREDICT_NORMALS: OPEN_BOUNDARY: IW, IOR, II,JJ, KK-1, U_NORMAL_S:', IW, IOR, II,JJ, KK-1, WC%ONE_D%U_NORMAL_S
#endif
            END SELECT
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'PREDICT_NORMALS: DUNDT: IW, RDT, U_NORMAL_S, U_NORMAL:', IW, RDT, &
                       WALL(IW)%ONE_D%U_NORMAL_S,WALL(IW)%ONE_D%U_NORMAL, WALL(IW)%DUNDT
#endif
   ENDDO
   !$OMP END PARALLEL DO
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A,3i4,E14.6)') 'DIVERGENCE_PART_2: I,J,K,DP:', I,J,K, DP(I,J,K)
#endif
         ENDDO
      ENDDO
   ENDDO
...
#ifdef WITH_SCARC_DEBUG
  CALL SCARC_DEBUG_VECTOR3_BIG (DP, NM, 'DIVG: DP AFTER ZONES')
#endif
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A,4i4,2E14.6)') 'DIVERGENCE_PART_2: SOLID, IOR, II,JJ,KK,DP:', IOR, II,JJ,KK, DP(II,JJ,KK), UN_P
#endif
            CASE(-1)
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A,3i4,E14.6)') 'DIVERGENCE_PART_2: OPEN, II,JJ,KK,DP:', II,JJ,KK, DP(II,JJ,KK)
#endif
   END SELECT
ENDDO BC_LOOP

#ifdef WITH_SCARC_DEBUG
  CALL SCARC_DEBUG_VECTOR3_BIG (DP, NM, 'DIVG: DP AFTER BOUNDARY')
  CALL SCARC_DEBUG_VECTOR3_BIG (U, NM, 'DIVG: U AFTER BOUNDARY')
  CALL SCARC_DEBUG_VECTOR3_BIG (V, NM, 'DIVG: V AFTER BOUNDARY')
  CALL SCARC_DEBUG_VECTOR3_BIG (W, NM, 'DIVG: W AFTER BOUNDARY')
#endif
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A,3i4,E24.16)') 'DIVERGENCE_PART_2: PREDICTOR, I,J,K,DIV:', I,J,K, DIV(I,J,K)
#endif
         ENDDO
      ENDDO
   ENDDO
   DDDT = (DP-DIV)*RDT
#ifdef WITH_SCARC_DEBUG
  CALL SCARC_DEBUG_VECTOR3_BIG (DIV, NM, 'DIVG: PREDICTOR: DIV BETWEEN ')
  CALL SCARC_DEBUG_VECTOR3_BIG (DP, NM, 'DIVG: PREDICTOR: DP BETWEEN ')
  CALL SCARC_DEBUG_VECTOR3_BIG (DDDT, NM, 'DIVG: PREDICTOR: DDDT BETWEEN ')
#endif
ELSEIF (CORRECTOR) THEN
#ifdef WITH_SCARC_DEBUG
  CALL SCARC_DEBUG_VECTOR3_BIG (U, NM, 'DIVG: PREDICTOR: U BETWEEN ')
  CALL SCARC_DEBUG_VECTOR3_BIG (V, NM, 'DIVG: PREDICTOR: V BETWEEN ')
  CALL SCARC_DEBUG_VECTOR3_BIG (W, NM, 'DIVG: PREDICTOR: W BETWEEN ')
  CALL SCARC_DEBUG_VECTOR3_BIG (US, NM, 'DIVG: PREDICTOR: US BETWEEN ')
  CALL SCARC_DEBUG_VECTOR3_BIG (VS, NM, 'DIVG: PREDICTOR: VS BETWEEN ')
  CALL SCARC_DEBUG_VECTOR3_BIG (WS, NM, 'DIVG: PREDICTOR: WS BETWEEN ')
  WRITE(MSG%LU_DEBUG,*) 'U, U-:', U(0,1,1), U(1,1,1), US(0,1,1), US(1,1,1)
  WRITE(MSG%LU_DEBUG,*) 'U, U-:', V(1,0,1), V(1,1,1), VS(1,0,1), VS(1,1,1)
  WRITE(MSG%LU_DEBUG,*) 'U, U-:', W(1,1,0), W(1,1,1), WS(1,1,0), WS(1,1,1)
#endif
   DO K = 1,KBAR
      DO J = 1,JBAR
         DO I = 1,IBAR
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A,3i4,E24.16)') 'DIVERGENCE_PART_2: CORRECTOR, I,J,K,DIV:', I,J,K, DIV(I,J,K)
#endif
         ENDDO
      ENDDO
   ENDDO
...
#ifdef WITH_SCARC_DEBUG
  CALL SCARC_DEBUG_VECTOR3_BIG (DP, NM, 'DIVG: CORRECTOR: DP BETWEEN ')
  CALL SCARC_DEBUG_VECTOR3_BIG (DIV, NM, 'DIVG: CORRECTOR: DIV BETWEEN ')
  CALL SCARC_DEBUG_VECTOR3_BIG (DDDT, NM, 'DIVG: CORRECTOR: DDDT BETWEEN ')
#endif
ENDIF
