...
SELECT CASE(NTYPE)
   CASE (NSCARC_MATRIX_POISSON)
      ...
      ELSE
         SCARC_POINT_TO_CMATRIX => G%POISSON_VAR
      ENDIF
   CASE (NSCARC_MATRIX_LAPLACE)
      IF (IS_SEPARABLE) THEN
         SCARC_POINT_TO_CMATRIX => G%LAPLACE
      ELSE
         SCARC_POINT_TO_CMATRIX => G%LAPLACE_VAR
      ENDIF
#ifdef WITH_MKL
   CASE (NSCARC_MATRIX_POISSON_SYM)
      ...
      ELSE
         SCARC_POINT_TO_CMATRIX => G%POISSON_VAR_SYM
      ENDIF
   CASE (NSCARC_MATRIX_LAPLACE_SYM)
      IF (IS_SEPARABLE) THEN
         SCARC_POINT_TO_CMATRIX => G%LAPLACE_SYM
      ELSE
         SCARC_POINT_TO_CMATRIX => G%LAPLACE_VAR_SYM
      ENDIF
#endif
