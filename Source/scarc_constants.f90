...
INTEGER, PARAMETER :: NSCARC_MGM_COPY_SS_TO_SP       = 31         !< Type of MGM copy: Copy HS to H1
INTEGER, PARAMETER :: NSCARC_MGM_COPY_US_TO_UP       = 32         !< Type of MGM copy: Copy HU to H3   
INTEGER, PARAMETER :: NSCARC_MGM_COPY_DSU_TO_UL       = 33         !< Type of MGM copy: Copy HD to H2         
INTEGER, PARAMETER :: NSCARC_MGM_COPY_DSU_TO_ULP       = 34         !< Type of MGM copy: Copy HD to H4        
INTEGER, PARAMETER :: NSCARC_MGM_COPY_UL_TO_ULP       = 35         !< Type of MGM copy: Copy H2 to H4        
INTEGER, PARAMETER :: NSCARC_MGM_COPY_SP_TO_UL       = 36         !< Type of MGM copy: Copy H1 to H3       
INTEGER, PARAMETER :: NSCARC_MGM_COPY_OBDRY_TO_PREV     = 37         !< Type of MGM copy: Copy OH1 to OH2     
INTEGER, PARAMETER :: NSCARC_MGM_DIFF_HU_VS_HS       = 41         !< Type of MGM difference: Build difference of HU and HS
INTEGER, PARAMETER :: NSCARC_MGM_DIFF_UL_VS_DSU       = 42         !< Type of MGM difference: Build difference of H2 and HD
INTEGER, PARAMETER :: NSCARC_MGM_DIFF_UP_VS_US       = 43         !< Type of MGM difference: Build difference of HS and H1     
