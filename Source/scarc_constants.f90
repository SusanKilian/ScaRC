...
INTEGER, PARAMETER :: NSCARC_MATRIX_POISSON_VAR      = 12        !< Flag for matrix selection: Poisson with variables entries
INTEGER, PARAMETER :: NSCARC_MATRIX_POISSON_VAR_SYM  = 13        !< Flag for matrix selection: Poisson with variables entries
INTEGER, PARAMETER :: NSCARC_MATRIX_LAPLACE          = 14        !< Flag for matrix selection: Laplace 
INTEGER, PARAMETER :: NSCARC_MATRIX_LAPLACE_SYM      = 15        !< Flag for matrix selection: symmetric Laplace 
INTEGER, PARAMETER :: NSCARC_MATRIX_LAPLACE_VAR      = 16        !< Flag for matrix selection: Laplace with variable entries
INTEGER, PARAMETER :: NSCARC_MATRIX_LAPLACE_VAR_SYM  = 17        !< Flag for matrix selection: Laplace with variable entries
INTEGER, PARAMETER :: NSCARC_MATRIX_PROLONGATION     = 18        !< Flag for matrix selection: Prolongation (AMG only)
INTEGER, PARAMETER :: NSCARC_MATRIX_RESTRICTION      = 19        !< Flag for matrix selection: Restriction (AMG only)
INTEGER, PARAMETER :: NSCARC_MATRIX_ZONES            = 20        !< Flag for matrix selection: Aggregation zones (AMG only)
INTEGER, PARAMETER :: NSCARC_MATRIX_LOWER            = 21        !< Flag for matrix selection: Lower matrix for MGM-LU decomposition
INTEGER, PARAMETER :: NSCARC_MATRIX_UPPER            = 22        !< Flag for matrix selection: Upper matrix for MGM-LU decomposition
