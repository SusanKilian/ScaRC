...
INTEGER, PARAMETER :: NSCARC_MATRIX_PROLONGATION     = 15        !< Flag for matrix selection: Prolongation (AMG only)
INTEGER, PARAMETER :: NSCARC_MATRIX_RESTRICTION      = 16        !< Flag for matrix selection: Restriction (AMG only)
INTEGER, PARAMETER :: NSCARC_MATRIX_ZONES            = 17        !< Flag for matrix selection: Aggregation zones (AMG only)
INTEGER, PARAMETER :: NSCARC_MATRIX_LOWER            = 18        !< Flag for matrix selection: Lower matrix for MGM-LU decomposition
INTEGER, PARAMETER :: NSCARC_MATRIX_UPPER            = 19        !< Flag for matrix selection: Upper matrix for MGM-LU decomposition
