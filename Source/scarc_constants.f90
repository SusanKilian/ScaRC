...
INTEGER, PARAMETER :: NSCARC_MATRIX_LAPLACE          = 13        !< Flag for matrix selection: Laplace 
INTEGER, PARAMETER :: NSCARC_MATRIX_LAPLACE_SYM      = 14        !< Flag for matrix selection: symmetric Laplace 
INTEGER, PARAMETER :: NSCARC_MATRIX_LAPLACE_VAR      = 15        !< Flag for matrix selection: Laplace with variable entries
INTEGER, PARAMETER :: NSCARC_MATRIX_PROLONGATION     = 16        !< Flag for matrix selection: Prolongation (AMG only)
INTEGER, PARAMETER :: NSCARC_MATRIX_RESTRICTION      = 17        !< Flag for matrix selection: Restriction (AMG only)
INTEGER, PARAMETER :: NSCARC_MATRIX_ZONES            = 18        !< Flag for matrix selection: Aggregation zones (AMG only)
INTEGER, PARAMETER :: NSCARC_MATRIX_LOWER            = 19        !< Flag for matrix selection: Lower matrix for MGM-LU decomposition
INTEGER, PARAMETER :: NSCARC_MATRIX_UPPER            = 20        !< Flag for matrix selection: Upper matrix for MGM-LU decomposition
