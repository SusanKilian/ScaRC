...
INTEGER, PARAMETER :: NSCARC_MATRIX_LAPLACE          = 12        !< Flag for matrix selection: Laplace 
INTEGER, PARAMETER :: NSCARC_MATRIX_LAPLACE_SYM      = 13        !< Flag for matrix selection: symmetric Laplace 
